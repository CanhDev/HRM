...
@Component({
  selector: 'app-leaveTypeFilter',
  templateUrl: './leaveTypeFilter.component.html',
  styleUrls: ['./leaveTypeFilter.component.css']
})
export class LeaveTypeFilterComponent implements  OnInit {
  ...
  applyFilters(): void {
    ...
    const columnKeys = ['leaveTypeCode', 'status'];
